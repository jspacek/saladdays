...
def needle_expected_value():
    ...
    ax.set(xlabel='n', ylabel='E[X] proxy assignments',
           title='Bounds on the average number of proxy assignments to find all proxies')
    ax.grid()
    #plt.show()
