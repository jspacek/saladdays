...
# A Jackson Network of M/M/c/n queues with uniform probability distribution
...
class Distributor(object):
    ...
    def assign(self, client):
        ...
        # Randomly select a proxy from the list to assign to the client
        random_index = random.randint(0,num_proxies-1)
        ...
        # Branch process to service the client
        env.process(random_proxy.service(client))
